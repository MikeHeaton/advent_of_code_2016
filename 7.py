# -*- coding: utf-8 -*-
"""
Created on Wed Dec  7 09:47:26 2016

@author: Mike
"""

stringinput = """xdsqxnovprgovwzkus[fmadbfsbqwzzrzrgdg]aeqornszgvbizdm
...
import re
print(len(list(filter(lambda x: re.findall("|".join([a+b+b+a for a in "abcdefghijklmnopqrstuvwxyz" for b in "abcdefghijklmnopqrstuvwxyz" if a != b]), x) and not re.findall("\[\w*(" + "|".join([a+b+b+a for a in "abcdefghijklmnopqrstuvwxyz" for b in "abcdefghijklmnopqrstuvwxyz" if a != b]) + ")\w*\]", x),stringinput.split("\n")))))
                        
print(len(list(filter(lambda x: re.findall("|".join([a+b+a + "\w*(\[\w*\]\w*)*\[\w*" + b+a+b + "\w*\]|\[\w*" + b+a+b + "\w*\](\w*\[\w*\])*\w*" + a+b+a for a in "abcdefghijklmnopqrstuvwxyz" for b in "abcdefghijklmnopqrstuvwxyz" if a != b]), x),stringinput.split("\n")))))
